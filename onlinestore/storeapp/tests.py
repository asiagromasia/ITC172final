...
class ProductTypesTest(TestCase):
    ...
    def test_tablename(self):
        self.assertEqual(str(ProductTypes._meta.db_table), 'producttype')
...
class ProductTest(TestCase):
    ...
    def test_tablename(self):
        self.assertEqual(str(Products._meta.db_table), 'product')
...
class OrderTest(TestCase):
    ...
    def test_tablename(self):
        self.assertEqual(str(Orders._meta.db_table), 'order')
...
class ReviewTest(TestCase):
    ...
    def test_tablename(self):
        self.assertEqual(str(Reviews._meta.db_table), 'review')
...
class TestProductTypes(TestCase):
    ...
    def test_view_uses_correct_template(self):
        response = self.client.get(reverse('getproducttypes'))
        self.assertTemplateUsed(response, 'storeapp/getproducttypes.html')
